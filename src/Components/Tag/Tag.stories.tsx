...
const Template5: Story = () => (
  <Tag variant="orange-white-icon" label="Tag Name" icon="UIUXIcon" />
);
export const OrangeWhiteIcon = Template5.bind({});

const Template6: Story = () => (
  <Tag variant="white-gray-icon1" label="Tag Name" icon="UIUXIcon" />
);
export const WhiteGrayIconL = Template6.bind({});

const Template7: Story = () => (
  <Tag variant="white-gray-icon2" label="Tag Name" icon="UIUXIcon" />
);
